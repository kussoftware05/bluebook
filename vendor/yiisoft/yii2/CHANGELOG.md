...
- Chg #15633: Deprecated XCache and Zend data cache support as caching admins (brandonkelly)
...
- Bug #12037: Fixed 2.0.7 regression in memcahe/memcached cache admin (samdark)
...
- Chg: Use `limit(null)` instead of `limit(-1)` in migration controller to be compatible to more admins (cebe)
